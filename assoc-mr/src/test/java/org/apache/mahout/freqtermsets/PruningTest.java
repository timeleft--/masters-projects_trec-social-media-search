...
public class PruningTest {
  ...
  public static void beforeClass() throws IOException, InterruptedException {
    // flist = PFPGrowth.readParallelCountingResults(countIn, 2, 3, 100, conf);
    flist = PFPGrowth.pruneParallelCountingResults(PFPGrowth.readParallelCountingResults(countIn,
        conf), 2, 3, 100);
    int ix = 0;
    ...
    fpGrowth
        .generateTopKFrequentPatterns(
            ...
            new ContextStatusUpdater<IntWritable, TransactionTree, Text, TopKStringPatterns>(
                context),
            -1,
            -1); // those will not be used as long as
